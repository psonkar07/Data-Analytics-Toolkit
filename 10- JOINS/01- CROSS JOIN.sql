...
-- Cross join , Userdetails & Transaction 
select * from userdetails cross join transaction ;

--  Cross join , Userdetails & Orders
select * from userdetails cross join orders ;

-- Cross join ,  Orders & Transaction
select * from orders cross join transaction ;

-- Cross join ,  Transaction & Orders
select * from transaction cross join orders ;

-- Cross join , Userdetails , Transaction & Orders 
select * from userdetails cross join transaction cross join orders ;
